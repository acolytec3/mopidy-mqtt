...
class MQTTFrontend(pykka.ThreadingActor, core.CoreListener):
    ...
    def mqtt_on_message(self, mqttc, obj, msg):
        ...
        if msg.topic == topPlay:
            ...
            logger.info("Track list size " + self.core.tracklist.get_length().get())
            logger.info("Track list location " + self.core.tracklist.index().get())
            ...
            elif msg.payload == "repeat_on":
                self.core.tracklist.set_repeat(True)
            elif msg.payload == "repeat_off":
